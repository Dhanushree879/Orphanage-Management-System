 ...
 * @author others
 */
public class requirementadd extends javax.swing.JFrame {

    /**
     * Creates new form AAAwelcome
     */
    public requirementadd() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ADD REQUIREMENTS");
                   ...
                   prp.setString(1, (jTextField1.getText()));
                    prp.setString(2, (jTextField5.getText()));
                      prp.setString(3, (jTextField2.getText()));
                       ...
                       prp.setInt(4, Integer.parseInt(jTextField3.getText())); 
prp.executeUpdate();
                   JOptionPane.showMessageDialog(null, "DATA SAVED");
                   requirementadd sp=new requirementadd();
                    sp.setVisible(true);
                   con.close();
                   dispose();
}
